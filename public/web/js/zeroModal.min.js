...
(function (a) {
    ...
    v += '           {{#close}}<div title="闂滈枆" zero-close-unique="{{unique}}" class="zeromodal-close"></div>{{/close}}';
    v += '           {{#max}}<div title="鏈€澶у寲/鍙栨秷鏈€澶у寲" zero-max-unique="{{unique}}" class="zeromodal-max"></div>{{/max}}';
    v += '           {{#min}}<div title="鏈€灏忓寲/鍙栨秷鏈€灏忓寲" zero-min-unique="{{unique}}" class="zeromodal-min"></div>{{/min}}';
