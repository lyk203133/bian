let bankHtml = `<select name="drpCardBank" id="drpCardBank" class="form_border">
    ...
    <option value="520 - 小港區漁會；高雄區漁會">520 - 小港區漁會；高雄區漁會</option>
    <option value="521 - 彌陀區漁會；永安區漁會；興達港區漁會；林園區漁會">521 - 彌陀區漁會；永安區漁會；興達港區漁會；林園區漁會</option>
    <option value="523 - 東港漁會；琉球區漁會；林邊區漁會">523 - 東港漁會；琉球區漁會；林邊區漁會</option>
    <option value="524 - 新港區漁會">524 - 新港區漁會</option>
    <option value="525 - 澎湖區漁會">525 - 澎湖區漁會</option>
    <option value="605 - 高雄市農會">605 - 高雄市農會</option>
    <option value="612 - 豐原市農會；神岡鄉農會">612 - 豐原市農會；神岡鄉農會</option>
    ...
    <option value="954 - 中南部地區農漁會">954 - 中南部地區農漁會</option>
</select>`